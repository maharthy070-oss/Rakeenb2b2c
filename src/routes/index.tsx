...
export const Route = createFileRoute("/")({
  head: () => ({
    meta: [
      { title: "لوحة جاهزيه قطاع المشاعر B2b2C لمخيمات عرفة عام 1447" },
      {
        name: "description",
        content: "لوحة متابعة جاهزية مخيمات عرفات لقطاع المشاعر — تحليل الأداء وتطور المواقع",
      },
      { property: "og:title", content: "لوحة جاهزيه قطاع المشاعر B2b2C لمخيمات عرفة عام 1447" },
      {
        property: "og:description",
        content: "متابعة جاهزية المواقع والأداء العام لقطاع المشاعر",
      },
    ],
    links: [
      ...
      <header className="border-b border-border bg-card/40 backdrop-blur sticky top-0 z-30">
        <div className="container mx-auto px-4 py-5 flex items-center justify-between gap-4 flex-wrap">
          ...
          <div className="flex items-center gap-4 md:gap-6 text-sm">
            <ReportGenerator inspections={inspections} />
